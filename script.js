...
<head>
    ...
    <style>
        ...
        #newGameBtn {
            background-color: #3498db; /* Light blue color for New Game button */
        }

        #exitBtn {
            background-color: #f1c40f; /* Yellow color for Exit button */
        }

        #backBtn {
            background-color: #3498db; /* Light blue color for Back to Game button */
        }
...
<body>
    ...
    <div id="rulesContainer" class="screen">
        ...
        <div id="rulesContainerContent">
            ...
            <p>4. Division: The quotient of two integers with the same sign is positive, and with different signs is negative. </p>
        </div>
